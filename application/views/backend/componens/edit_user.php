        ...
        <div class="col-md-12">
            ...
            <div class="ibox-body">
                ...
                <div class="form-group row"> 
                    ...
                    <div class="col-sm-10">
                        <select name="level" class="form-control" value="<?= $users->level ?>">
                            ...
                            ?>
                            <option value="<?php echo $level ?>" <?=($users->level = $level)?'selected':''?>><?php echo $level ?></option>
                            <?php } ?>
                        </select> 
                    </div>
                </div>
                ...
                <div class="form-group row"> 
                    ...
                    <div class="col-sm-10">
                        <select name="status" class="form-control" value="<?= $barang->status ?>">
                            ...
                            ?>
                            <option value="<?php echo $status ?>" <?=($users->status==$status)?'selected':''?>><?php echo $status ?></option>
                            <?php } ?>
                        </select> 
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <button type="submit" name="update" class="button button-primary" value="upadate">Update</button>
                    </div>
                </div>
                </form>
            </div>
